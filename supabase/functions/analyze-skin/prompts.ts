...
For the chosen moisturizer, provide a concise personalized description of why it's suitable for this person's skin, including usage instructions (when and how to apply);
...
For the chosen cleanser, provide a concise personalized description of why it's suitable for this person's skin, including usage instructions (when and how to apply);
...
For the chosen exfoliant, provide a concise personalized description of why it's suitable for this person's skin, including usage instructions (when and how to apply);
...
For the chosen sunscreen, provide a concise personalized description of why it's suitable for this person's skin, including usage instructions (when and how to apply);
...
For the chosen retinol, provide a concise personalized description of why it's suitable for this person's skin, including usage instructions (when and how to apply)`,
...
För den valda fuktgivaren, ge en koncis personlig beskrivning av varför den passar denna persons hud, inklusive användningsinstruktioner (när och hur den ska appliceras);
...
För den valda rengöringen, ge en koncis personlig beskrivning av varför den passar denna persons hud, inklusive användningsinstruktioner (när och hur den ska appliceras);
...
För den valda exfolianten, ge en koncis personlig beskrivning av varför den passar denna persons hud, inklusive användningsinstruktioner (när och hur den ska appliceras);
...
För det valda solskyddet, ge en koncis personlig beskrivning av varför det passar denna persons hud, inklusive användningsinstruktioner (när och hur det ska appliceras);
...
För den valda retinolen, ge en koncis personlig beskrivning av varför den passar denna persons hud, inklusive användningsinstruktioner (när och hur den ska appliceras)`
};